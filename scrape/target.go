...
func (app *limitAppender) Append(ref storage.SeriesRef, lset labels.Labels, t int64, v float64, seriesMeta []metadata.SeriesMetadata) (storage.SeriesRef, error) {
...
func (app *bucketLimitAppender) AppendHistogram(ref storage.SeriesRef, lset labels.Labels, t int64, h *histogram.Histogram, fh *histogram.FloatHistogram, seriesMeta []metadata.SeriesMetadata) (storage.SeriesRef, error) {
	if h != nil {
	...
	ref, err := app.Appender.AppendHistogram(ref, lset, t, h, fh, seriesMeta)
	if err != nil {
		return 0, err
	}
	return ref, nil
...
func (app *maxSchemaAppender) AppendHistogram(ref storage.SeriesRef, lset labels.Labels, t int64, h *histogram.Histogram, fh *histogram.FloatHistogram, seriesMeta []metadata.SeriesMetadata) (storage.SeriesRef, error) {
	if h != nil {
