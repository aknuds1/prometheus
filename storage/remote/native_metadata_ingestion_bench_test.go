...
// BenchmarkNativeMetadataIngestion exercises RW2 append and OTLP translation
// into the Head. It excludes HTTP decoding and wire encoding.
func BenchmarkNativeMetadataIngestion(b *testing.B) {
