...
// BenchmarkHeadMetricMetadataFixedConcurrency keeps the series, worker count,
// batch size, and total work fixed while GOMAXPROCS changes.
// CPU counts that do not divide eight are skipped.
func BenchmarkHeadMetricMetadataFixedConcurrency(b *testing.B) {
